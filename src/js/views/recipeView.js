...
class RecipeView extends View {
  ...
  addHandlerRender(handler) {
    //listening for load and hashchange in one eventListener
  ...
  _generateMarkup() {
    ...
    <div class='recipe__ingredients'>
      ...
      ${this._data.ingredients.map(RecipeView.#generateMarkupIngredients).join(``)}
  ...
  static #generateMarkupIngredients(ingredient) {
    return `
